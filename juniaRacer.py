...
driver = importlib.import_module("drivers.pauline3", package = None)
...
bg = pygame.image.load('bg72.png')
bg4 = pygame.image.load('bg42.png')
...
while True:
    ...
    driver_action = driver.drive(car.d1, car.d2, car.d3, car.d4, car.d5, car.velocity)
